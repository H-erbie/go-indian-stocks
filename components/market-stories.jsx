...
const MarketStories = ({activeTab}) => {
  ...
  return (
    <section className={activeTab === 'market stories'?" sm:pr-10 block sm:mx-auto lg:mx-0 w-full mx-0 sm:w-3/4 lg:w-[25%]":"hidden lg:block w-3/4 mx-auto lg:mx-0 lg:w-[25%] pr-10"}>
      ...
      <div>
        {marketStories.map((forum) => {
          ...
          return (
            ...
            key={id}
            fallback={
              <div className="w-full h-[296px] bg-gray-400 animate-pulse rounded-lg"></div>
            }
          >
            <MarketStoryCard
              id={id}
